...
void CTalkDlg::OnBtnLogin() 
{
	...
	LONG lLoginHandle = CLIENT_LoginEx2((LPSTR)(LPCSTR)strIp, nPort, (LPSTR)(LPCSTR)strUser, 
		(LPSTR)(LPCSTR)strPwd, EM_LOGIN_SPEC_CAP_TCP, NULL, 
		&deviceInfo, &nError);
	if (lLoginHandle != 0)
	{
		m_lLoginHandle = lLoginHandle;
		m_lDevChnNum = deviceInfo.nChanNum;

...
#define DH_PLAY_COMMON_ERROR			1		// common error
#define	DH_PLAY_PARA_INVALID			2		// Illegal input parameter
#define DH_PLAY_ORDER_ERROR				3		// Callback sequence is not right
#define	DH_PLAY_PORT_OPEN				4		// port is already open
#define	DH_PLAY_PORT_CLOSE				5		// port is already close
#define	DH_PLAY_PORT_INVALID			6		// Illegal port
#define	DH_PLAY_PORT_EXIST				7		// port is already exist
#define DH_PLAY_OPEN_FILE_ERROR			8		// open file failed
#define DH_PLAY_INTERFACE_NOT_SUPPORT	9		// Interface is not supported
#define DH_PLAY_HWND_INVALID			10		// Illegal hwnd
#define DH_PLAY_PLAY_ERROR				11		// play failed
#define DH_PLAY_SPEED_INVALID			12		// Illegal speed
#define DH_PLAY_NOT_FILE				13		// not file mode
#define DH_PLAY_NOT_STREAM				14		// not stream mode
#define DH_PLAY_NO_FRAME				15		// current is no frame
#define DH_PLAY_INDEX_NOT_COMPLETE		16		// index is not complete
#define DH_PLAY_INDEX_COMPLETE			17		// index is complete
#define DH_PLAY_GET_FILE_SIZE_ERROR		18		// get file size failed
#define DH_PLAY_CREATE_THREAD_FAIL		19		// create thread failed
#define DH_PLAY_CREATE_EVENT_FAIL		20		// create event failed
#define DH_PLAY_SOUND_SHARE_MODE		21		// sound share mode
#define DH_PLAY_INCLUDE_SOUND_SHARE_PORT     22 // sound share port is already include
#define DH_PLAY_NOT_INCLUDE_SOUND_SHARE_PORT 23	// sound share port is not include
#define DH_PLAY_CREATE_DIR_ERROR			 24	// create dir failed
#define DH_PLAY_CREATE_FILE_ERROR			 25	// create file failed

#define DH_PLAY_CONVERT_YUV_ERROR			 26 // convert yuv failed
#define DH_PLAY_CONVERT_JPG_ERROR			 27	// convert jpg failed
#define DH_PLAY_CONVERT_BMP_ERROR			 28	// convert bmp failed
#define DH_PLAY_CONVERT_TIFF_ERROR			 29	// convert tiff failed
#define DH_PLAY_HW_CATCH_ERROR				 30	// Hardware acceleration catch failed
#define DH_PLAY_CREATE_VIDEO_RENDER_ERROR	 31	// create video render failed
#define DH_PLAY_NOT_SUPPORT_REF_VALUE		 32	// file index setting is not supported
#define DH_PLAY_FORMAT_NOT_SUPPORT			 33	// format is not supported
#define DH_PLAY_CREATE_RECORD_ERROR			 34	// create record failed
#define DH_PLAY_OPEN_RECORD_ERROR			 35	// open record failed
#define DH_PLAY_FRAMERATE_ERROR				 36	// frame rate failed
#define DH_PLAY_CREATE_AUDIO_RECORD_ERROR	 37	// create audio record failed
#define DH_PLAY_OPEN_AUDIO_RECORD_ERROR		 38	// open audio record failed
#define	DH_PLAY_AES_ALLOC_ERROR				 39	// aes_alloc failed

#define DH_PLAY_BUF_OVER				     40  // buffer is over
#define DH_PLAY_ALLOC_MEMORY_ERROR		     41  // alloc memory failed
...
typedef struct _FILE_INFO
{
	...
	BYTE		lock_flag;				// (0 unlock 1 manual 2 auto)
 ...
 * @param[in] encodetype Encode type,0 for pcm, 1 for g711a,2 for g711u
 * @return BOOL,TRUE--succeeded FALSE--failed.
 * @note if failed,you can get the error code by calling PLAY_GetLastErrorEx.
 */
 ...
 *
 * @param[in] pfRatio Zoom rate.from 0 to 1=zoom in audio.1=Original audio.Over 1=audio zoom out.
 * @return BOOL,TRUE--succeeded FALSE--failed.
 * @note if failed,you can get the error code by calling PLAY_GetLastErrorEx.
 */
 ...
 * @param[in] hint no meaning, should input 0.
 ...
 *
 * @param[in] nPort Port number
 * @param[in] pBuf Raw data with Dahua head
 * @param[in] nSize Buffer Size
 * @param[in] pUserData  Customized Parameter
  * @return BOOL,TRUE--succeeded FALSE--failed.
 * @note if failed,you can get the error code by calling PLAY_GetLastErrorEx.
...
/*
 * Data Frame CallBack,callback  the original data which has Dahua head, and the outer layer is parsed by itself
 *
 * @param[in] nPort Port number

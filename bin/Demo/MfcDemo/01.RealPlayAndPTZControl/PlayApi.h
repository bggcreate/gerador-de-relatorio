...
typedef BOOL (__stdcall *PLAY_API_SetSecurityKey)(LONG nPort,char* szKey,DWORD nKeylen);
...
public:
    ...
    BOOL	PLAY_SetSecurityKey(LONG nPort,const char* szKeyID, DWORD nKeyIDLen,const char* szKey, DWORD nKeyLen);
private:
	HMODULE							m_hModule;
    ...
    PLAY_API_SetSecurityKey        m_APISetSecurityKey;
};
#endif
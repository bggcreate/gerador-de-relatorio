...
public:
	...
	friend void CALLBACK EncryptRealDataCallBackEx(LLONG lRealHandle, BYTE *pBuffer, DWORD dwBufSize, LDWORD dwUser);
...
private:
	...
	void SendSecurityKeyTo3rdPartyLib(int nChannelID, int niDispNum);

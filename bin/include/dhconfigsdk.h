...
#define MAX_CROWD_DISTRI_MAP_REGION_POINT_NUM	4			// CrowdDistriMap region point num
...
// Rule type EVENT_IVS_TRAFFIC_PARKING/EVENT_IVS_TRAFFIC_PARKING_B/EVENT_IVS_TRAFFIC_PARKING_C/EVENT_IVS_TRAFFIC_PARKING_D configuration
